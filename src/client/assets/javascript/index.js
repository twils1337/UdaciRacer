...
async function handleCreateRace() {
	// render starting UI
	try {
		renderAt('#race', renderRaceStartView(store.raceTracks[store.track_id-1]));
...
function renderRaceStartView(track) {
	return `
		<header style="background-image: url('../assets/images/race_bg.jpg'); background-repeat:no-repeat; background-size:cover;">
